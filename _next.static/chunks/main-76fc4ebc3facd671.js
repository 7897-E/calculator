    ...
    5480: function(e, t, r) {
        ...
        function Z(e) {
            ...
            i.loadPage("/_error").then(n => {
                ...
                return (null == s ? void 0 : s.Component) === o ? Promise.resolve().then( () => m._(r(6412))).then(n => Promise.resolve().then( () => m._(r(9825))).then(r => (t = r.default,
                e.App = t,
                n))).then(e => ({
        ...
        class X {
            ...
            async getRouteInfo(e) {
                ...
                try {
                    ...
                    return w.__N_SSP && O.dataHref && M && delete this.sdc[M],
